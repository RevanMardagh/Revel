...
def generate_ai_overview(logs_dict, api_key: str) -> str:
    ...
    """
    prompt = f"""
    You are a cybersecurity analyst. I will provide a dictionary containing IP addresses and their log statistics, including HTTP status counts, total requests, 4xx ratios, user agents, virustotal, and abuseipdb reports.
    ...
    - For malicious or benign IPs, give individual summaries for every IP. The Virustotal and AbuseIPBD scores will be provided for you
